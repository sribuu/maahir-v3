export enum ResellerHomeReactQueryKey {
  GetHighlightProducts = "reseller-home_get-highlight-products",
  AddViralProductToCart = "reseller-home_add-viral-product-to-cart",
