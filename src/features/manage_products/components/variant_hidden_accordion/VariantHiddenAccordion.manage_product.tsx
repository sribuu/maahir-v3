...
export interface IVariantHiddenAccordionManageProductProps {
  variantItem?: {
    name?: string;
    price?: string;
    stock?: number;
...
VariantHiddenAccordionManageProduct.defaultProps = {
  variantItem: [],
  total: 0,
};

export default function VariantHiddenAccordionManageProduct(
  props: IVariantHiddenAccordionManageProductProps
) {
